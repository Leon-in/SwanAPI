...
export const SWAN_PUBLIC_LAYOUT = {
  headerClassName:
    'bg-[#071312]/50 text-white ring-1 ring-white/10 backdrop-blur-2xl [&_a]:text-white/75 [&_a:hover]:text-white [&_button]:text-white/80 [&_button:hover]:text-white [&_span]:text-white',
